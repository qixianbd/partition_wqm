...
RCS_BASE(
    "$Id: labinfo.cc,v 1.1.1.1 1998/06/16 15:15:32 brm Exp $")
...
static char *k_useful_labinfo_info;
static char *k_useful_labinfo_backward;
static char *k_useful_labinfo_num_back;
