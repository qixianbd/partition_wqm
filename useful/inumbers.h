            ...
            if (((long)min_value) == (long)LONG_MIN)                       \
              {                                                            \
                if (((unsigned long)max_value) <= (unsigned long)LONG_MAX) \
                    return (value.long_val OP (long)other);                \
                else                                                       \
                    return (((int_type)(value.long_val)) OP other);        \
              }                                                            \
              ...
              {                                                            \
                if (((unsigned long)max_value) >= (unsigned long)LONG_MAX) \
                  ...
                  {                                                        \
                    if (value.long_val <= (long)max_value)                 \
                        return (((int_type)(value.long_val)) OP other);    \
                    else                                                   \
                        return 10 OP 5;                                    \
                  }                                                        \
...
COMP_OPS(unsigned char, UCHAR_MAX, 0)
COMP_OPS(short, SHRT_MAX, SHRT_MIN)
COMP_OPS(unsigned short, USHRT_MAX, 0)
