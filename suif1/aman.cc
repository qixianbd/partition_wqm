...
RCS_BASE(
    "$Id: aman.cc,v 1.2 1999/08/25 03:29:08 brm Exp $")
...
annote_def::annote_def (char *n, boolean b)
{
...
struct_annote_def::struct_annote_def (char *n, boolean b,
