...
RCS_BASE(
    "$Id: instruction.cc,v 1.3 1999/08/25 16:40:00 suifoid Exp $")
...
in_gen::in_gen (char *o, type_node *t, operand d, unsigned n)
...
void
in_gen::init (char *o, operand d, unsigned n, operand s0, operand s1,
