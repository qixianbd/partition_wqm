...
RCS_HEADER(types_h,
    "$Id: types.h,v 1.4 1999/09/02 05:20:06 dlheine Exp $")
...
public:
    ...
    char *field_name(unsigned n)	{ check_range(n); return names[n]; }
...
public:
    enum_type(char *nm,			/* name of this enumeration */
	      int s,			/* size in bits */
